...
// Get petugas level ID
$level_petugas = mysqli_query($koneksi, "SELECT id_level FROM tb_level WHERE level = 'petugas'");
$level_petugas = mysqli_fetch_assoc($level_petugas)['id_level'];
...
if (isset($_POST['submit'])) {
  ...
  $query = "INSERT INTO tb_petugas (nama_petugas, username, password, id_level) 
            VALUES ('$nama_petugas', '$username', '$password', '$level_petugas')";
...
<head>
  <meta charset="UTF-8">
  <title>Tambah Petugas - LELON</title>
  ...
  <style>
    ...
    .form-container { background-color: white; padding: 30px; border-radius: 10px; box-shadow: 0 0 10px rgba(0,0,0,0.1); }
  </style>
</head>
...
<body>
  ...
  <div class="main">
    ...
    <div class="content">
      <h3 class="dashboard-title">Tambah Petugas</h3>
