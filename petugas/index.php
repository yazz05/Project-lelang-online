...
// Pisahkan jumlah admin dan petugas berdasarkan id_level
$resultAdmin = mysqli_query($koneksi, "SELECT COUNT(*) AS total_admin FROM tb_petugas WHERE id_level = 1");
$admin = mysqli_fetch_assoc($resultAdmin)['total_admin'];

$resultPetugas = mysqli_query($koneksi, "SELECT COUNT(*) AS total_petugas FROM tb_petugas WHERE id_level = 2");
...
<head>
  <meta charset="UTF-8">
  <title>Dashboard Petugas - LELON</title>
...
<body>
  ...
  <div class="main">
    ...
    <div class="content">
      <div class="dashboard-title">Dashboard Petugas</div>
